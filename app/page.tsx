    ...
    content: (
      ...
      <div className="space-y-6">
        ...
        <p>
          ...
          Our goal is to make finding the right domain
          simpler, clearer and more efficient.
        </p>


        <p>
          A domain name is more than just an address.
          It represents a brand, a product and an online
          presence. Meaningful domain discovery is becoming
...

  {
    ...
    content: (
      ...
      <div className="space-y-6">
        ...
        <p>
          The history of domains is closely connected to
          the development of the internet. As the internet
          expanded, users needed more flexible naming
          systems.
        </p>
        ...
        <p>
          ...
          It provides another option for building
          recognizable online presences in a changing
          internet.
        </p>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            Explore the world of .xyz domains with Zetein.
          </p>
          ...
          >
            Explore the world of .xyz domains with Zetein.
            Discover, search, and register the perfect domain
            for your next idea.
          </p>
